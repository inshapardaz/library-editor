...
// Local imports
import { IconSave, IconZoomIn, IconZoomOut, IconUndo, IconRedo, IconBold, IconItalic, IconUnderline, IconSubScript, IconStrikethrough, IconSuperScript, IconLink, IconAutoCorrect, IconPunctuation, IconSpellCheck, IconJoinLines } from "@/components/icons";
            ...
            <Group>
                ...
                <If condition={configuration.spellchecker.enabled}>
                    <Button.Group>
                        ...
                        <CheckboxButton tooltip={t('editor.joinLines')}
                            size="lg"
                            icon={<IconJoinLines />}
                            onClick={() => editor.dispatchCommand(JOIN_LINES_COMMAND)} />
                    </Button.Group>
                </If>

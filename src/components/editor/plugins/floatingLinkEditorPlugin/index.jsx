...
// Local Imports
import './index.css';
import { ActionIcon, Card, Group, Input } from '@mantine/core';
import { IconX, IconEdit, IconDelete, IconTick } from '@/components/icons';
      ...
      {!isLink ? null : isLinkEditMode ? (
        <Card shadow="sm" padding="xs" radius="md" withBorder>
          <Group justify="space-between" gap="sm" >
            <Input style={{ minWidth: 298, direction: 'ltr' }}
              ref={inputRef}
              value={editedLinkUrl}
              onChange={(event) => {
            ...
            />
            <ActionIcon variant='default' onClick={() => setIsLinkEditMode(false)}
            >
              <IconX />
            </ActionIcon>
            <ActionIcon variant='outline' color="green" onClick={handleLinkSubmission}>
              <IconTick />
            </ActionIcon>
          </Group>
        </Card>
        ...
        <Card shadow="sm" padding="xs" radius="md" withBorder>
          <Group justify="space-between" gap="sm" className="link-view">
            <a
...
FloatingLinkEditorPlugin.prototypes = {
  anchorElem: PropTypes.element,
  isLinkEditMode: PropTypes.bool,
  setIsLinkEditMode: PropTypes.bool
}

...
// Internal Imports
import { useGetBookChaptersQuery, useUpdateChapterSequenceMutation } from "../../../features/api/booksSlice";
...
const ChaptersList = ({ libraryId, bookId, t, selectedChapterNumber = null, size = "default", hideTitle = false }) => {
    ...
    const { refetch, data: chapters, error, isFetching } = useGetBookChaptersQuery({ libraryId, bookId }, { skip: !libraryId || !bookId });
    const [ updateChapterSequence, { isLoading: isUpdating }] = useUpdateChapterSequenceMutation();
    ...
    <DataContainer
            ...
            emptyContent={<ChapterEditor libraryId={libraryId} bookId={bookId} t={t} buttonType="dashed" />}
            ...
            <DragDropContext onDragEnd={onDragDrop}>
                ...
                {(provided) => (
                    <div ref={provided.innerRef} {...provided.droppableProps}>
                        <List size={size} itemLayout="horizontal" dataSource={chapters ? chapters.data : []} header={header} renderItem={(chapter) => <ChapterListItem key={chapter.id} t={t} selected={selectedChapterNumber === chapter.chapterNumber} libraryId={libraryId} bookId={bookId} chapter={chapter} />} >

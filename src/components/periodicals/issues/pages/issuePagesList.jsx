...
import IssuePageAssignmentFilterButton from "./issuePageAssignmentFilterButton";
import IssuePageStatusFilterButton from "./issuePageStatusFilterButton";
import IssuePageSortButton from "./issuePageSortButton";
// ------------------------------------------------------
...
const IssuePagesList = ({ libraryId, issue, t, size = "default" }) => {
    ...
    const renderPage = (page) => {
        if (showList) {
            return (
                <IssuePageListItem
                    key={`issue_page_${page.sequenceNumber}`}
                    t={t}
        ...
        <>
            ...
            >
                <DragDropContext onDragEnd={onDragDrop}>
                    <Droppable droppableId={`issue_${issue?.id}_pages_droppable`}>
                        {(provided) => (
                            <div

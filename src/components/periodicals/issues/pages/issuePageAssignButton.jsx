...
import { useAssignIssuePagesMutation } from "/src/store/slices/issuesSlice";
import UserSelect from "/src/components/userSelect";
import BatchActionDrawer from "/src/components/batchActionDrawer";

// ------------------------------------------------------

const IssuePageAssignButton = ({ libraryId, pages, t, type, showDetails = false, showIcon = true }) => {

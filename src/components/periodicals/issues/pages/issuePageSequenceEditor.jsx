...
import { useUpdateIssuePageSequenceMutation } from "/src/store/slices/issuesSlice";

// ------------------------------------------------------

const IssuePageSequenceEditor = ({ page, t, type }) => {
    const { message } = App.useApp();
    const [form] = Form.useForm();
    const [open, setOpen] = useState(false);
    const [updateIssuePageSequence, { isLoading: isUpdating }] =
...
export default IssuePageSequenceEditor;

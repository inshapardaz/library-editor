    ...
    issue: {
        ...
        actions: {
            ...
            publish: {
                title: "شمارہ شائع",
                message:
                    "کیا آپ شمارہ '{{title}}'کو شائع کرنا چاہیں گے؟ تمام صفحات کا متن جمع کر کے تصنیفات میں لکھ دیا جائے گا اور اس سے تصنیفات کا موجودہ متن  ضائع ہو جائے گا۔",
                busyMessage: "شمارہ شائع کی جا رہی ہے۔۔۔",
                updateBookStatus: "شمارہ کی کیفیت تبدیل کریں؟",

const ur = {
	...
	"library" : {
        ...
        "actions" : {
            ...
            "delete": {
                ...
                "message": "کیا آپ کتب خانہ '{{title}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اس کتب خانہ سے متعلق تمام مواد بشمول کتب، مصنّفین، زمرہ جات، سلسلہ جات اور تمام رسائل حذف ہو جائیں گی۔",
        ...
        "actions": {
            ...
            "loadFileImages": {
                ...
                "messages" : {
                    ...
                    "loadingPages": "پی ڈی ایف کے صفحات لوڈ ہو رہے ہیں۔ اس میں کچھ وقت لگ سکتا ہے۔ برائے مہربانی براؤزر کو کھلا اور فوکس میں رکھیں۔",
                    "savingPages": "صفحات محفوظ ہو رہے ہیں۔ اس میں کچھ وقت لگ سکتا ہے۔ برائے مہربانی براؤزر کو کھلا اور فوکس میں رکھیں۔",
                    ...
                    "errorLoadingSavedSettings": "محفوظ شدہ ترجیحات ناقابلِ استعمال ہیں اور انہیں حذف کر دیا گیا ہے۔"
                }
            },
            "split": {
                "title" : "تقسیم کریں"
    ...
    "chapter" : {
        ...
        "actions": {
            ...
            "delete": {
                ...
                "message_other": "کیا آپ ابواب '{{titles}}' کو حذف کرنا چاہتے ہیں؟",
    ...
    "pages" : {
        ...
        "actions": {
            ...
            "autoFillChapter": {
                ...
                "message" : "آپ ہر باب کے پہلے صفحے کو بھر دیں اور پھر خودکار طور پر باقی صفحات بھر دیے جائیں گے۔ ایسا کرنے سے صفحات کے ابواب تبدیل ہو جائیں گے۔ کیا آپ صفحات کے ابواب بھرنا چاہیں گے؟",
            }
        }
    },
    "page" : {
        ...
        "actions": {
            ...
            "ocr": {
                ...
                "message": "کیا آپ صفحات '{{ sequenceNumber }}' کا متن حاصل کرنا چاہیں گے؟ ایسا کرنے سے صفحات کا موجودہ متن حذف ہو جائے گا اور اسے دوبارہ حاصل نہیں کیا جا سکتا۔",
                "success": "متن حاصل ہو گیا ہے۔",
                "error": "متن حاصل نہیں کیا جا سکا۔",
                "key": {
                    "label": "او سی آر کی کلید",
                    "description": "اسے متن حاصل کرنے کے لیے استعمال کیا جائے گا۔",
                    "required" : "او سی آر کی کلید درکار ہے۔"
                },
                "saveKey": {
                    "label": "کلید محفوظ کیجیے",
                    "description": "یہ کلید آپ کے کمپیوٹر پر ہی محفوظ ہو گی اور اس کا کوئی حصّہ ہمارے سرور پر محفوظ نہیں کہا جا سکے گا۔ اگر آپ پبلک کمپیوٹر یا ایسا کمپیوٹر استعمال کر رہے ہیں جس تک دوسرے لوگ کی رسائی ہو تو ہم آپ کو اس کلید کو محفوظ کرنے سے اجتناب برتئے۔",
                }
            },
            "sequence": {
                "label" : "ترتیب",
	...
	"author" : {
        ...
        "actions": {
            ...
            "delete": {
                ...
                "message": "کیا آپ مصنّف '{{name}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اس مصنّف سے متعلق تمام مواد بشمول کتب، تصنیفات اور تمام دستاویزات حذف ہو جائیں گی۔",
    ...
    "article" : {
        ...
        "messages" : {
            "newContent" : "اس مضمون کے مندرجات اس زبان میں موجود نہیں۔ آپ نیا مواد تخلیق کر رہے ہیں۔"
        },
        "actions": {
            "add": {
            ...
            "delete": {
                ...
                "message": "کیا آپ تصنیف '{{title}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اِس تصنیف سے متعلق تمام مواد حذف ہو جائے گا۔",
        ...
        "errors": {
            "contentNotFound": {
                ...
                "subTitle": "برائے مہربانی مندرجہ ذیل زبانوں میں سے کسی ایک کا انتخاب کریں۔",
	...
	"series" : {
        ...
        "actions": {
            ...
            "delete": {
                ...
                "message": "کیا آپ سلسلہ '{{name}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اِس سلسلے سے متعلق تمام مواد حذف ہو جائے گا۔",
    ...
    "category" : {
        ...
        "actions": {
            ...
            "delete": {
                "title" : "زمرہ حذف کریں؟",
                "message": "کیا آپ زمرہ '{{name}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اِس زمرے سے متعلق تمام مواد حذف ہو جائے گا۔",
	...
	"periodical" : {
        ...
        "actions": {
            ...
            "delete": {
                ...
                "message": "کیا آپ جریدہ '{{name}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اِس جریدے سے متعلق تمام مواد بشمول شمارے، مندرجات اور دستاویز حذف ہو جائے گا۔",
    ...
    "issue": {
        ...
        "actions": {
            ...
            "delete": {
                ...
                "message": "کیا آپ شمارہ '{{name}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اِس شمارے سے متعلق تمام مواد بشمول مندرجات اور دستاویز حذف ہو جائے گا۔",

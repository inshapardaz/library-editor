const ur = {
	...
	"author" : {
        ...
        "actions": {
            ...
            "delete": {
                ...
                "message": "کیا آپ مصنّف '{{name}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اس مصنّف سے متعلق تمام مواد بشمول کتب، مضامین اور تمام دستاویزات حذف ہو جائیں گی۔",
    ...
    "article" : {
        "title": {
            ...
            "required": "مضمون کے لیے نام ضروری ہے"
        },
        "type": {
            "label": "قسم",
            "placeholder": "مضمون کی قسم",
            "required": "مضمون کی قسم ضروری ہے",
            "writing" : "نثر",
            "poetry" : "شاعری"
        },
        "public": {
        ...
        "authors": {
            "label" : "مصنّفین",
            "placeholder" : "مضمون کے مصنّفین کا نام",
            "required" : "مصنّف کا نام ضروری ہے"
        },
        "status": {
            "label": "کیفیت",
            "placeholder" : "مضمون کی کیفیت چنیں"
        },
        "categories": {
            "label" : "زمرہ جات",
            "placeholder" : "مضمون کے زمرہ جات چنیں"
        },
        "actions": {
            "add": {
                "label": "نیا مضمون بنائیں",
                "title": "نیا مضمون",
                "success" :"مضمون کامیابی سے تخلیق کر دیا گیا ہے۔",
		        "error" :"مضمون تخلیق کرنے میں ناکامی ہوئی۔"
            },
            "edit": {
                "title": "'{{name}}' کی تدوین",
                "success" :"مضمون میں تبدیلیاں محفوظ ہو گئی ہیں۔",
                "error" :"مضمون میں تبدیلیاں محفوظ نہیں کی جا سکیں۔"
            },
            "delete": {
                "title" : "مضمون حذف کریں؟",
                "message": "کیا آپ مضمون '{{name}}' کو حذف کرنا چاہیں گے؟ ایسا کرنے سے اِس مضمون سے متعلق تمام مواد حذف ہو جائے گا۔",
                "success" :"مضمون حذف کر دیا گیا ہے۔",
                "error" :"مضمون حذف کرنے میں ناکامی ہوئی۔"
            }
        }
    },
	"series" : {

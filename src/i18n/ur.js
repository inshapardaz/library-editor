const ur = {
	...
	"forgotPassword" : {
		...
		"success" : "پاس ورڈ تبدیل کرنے کے لیے ای میل ارسال کر دی گئی ہے۔ اس کی ہدایات پر عمل کیجیے۔",
	...
	"register" : {
		...
		"invitation" : {
			"expired": "دعوت نامہ اب قابلِ قبول نہیں۔ نئی دعوت کے لیے ہم سے رابطہ کیجیے",
	...
	"home" : {
		"welcome": "نوشتہ میں خوش آمدید۔ یہاں آپ لائیبریوں سے منتفیض ہو سکتے ہیں۔",
	...
	"books": {
		...
		"title" : "کتب",
		"empty" : "کتاب دستیاب نہیں",
		"loadingError": "کتابوں کے حصول میں ناکامی ہوئی",
        "actions" : {
            "add": "نئی کتاب بنائیں"
        }
	},
	"book" : {
        ...
        "save": {
            "success": "کتاب محفوظ کر دی گئی ہے",
		    "error": "کتاب محفوظ نہیں کی جا سکی"
        }
	},
	"chapters" : {
		"title": "ابواب"
	...
	"author" : {
        ...
        "save": {
            ...
            "error":"مصنّف میں تبدیلیاں محفوظ نہیں ہوئں۔"
        }
	},
	"series" : {
		"title" : "سلسلے",
    ...
    "issue": {
        "volumeNumber": {
            ...
            "required": "سمارے کا جلد نمبر جاہیے۔ اگر جلد نمبر نہیں تو صفر استعمال کیجئے۔",
        },
        "issueNumber": {
            "label": "شمارہ  نمبر",
	...
	"downloader" : {
		...
		"description": "اس بات کو یقینی بنائیں کہ ربط سے آپ کتاب کے صفحات کا مطالعہ کر سکتے ہیں۔",
		"loading" :"کتاب ڈاؤنلوٖڈ کی جا رہی ہے۔۔۔ کتاب کے حصول میں کچھ وقت لگ سکتا ہے۔ برائے مہربانی براؤزر بند نہ کریں اور انتظار کیجئے۔",
		"url" : {
			"title" : "کتاب کا ربط",
			"required" : "کتاب کا ربط ضروری ہے",
			"detailsLink" : "ربط کتاب کے تعارفی صفحے کا ہے۔ برائے مہربانی کتاب کے صفحے کا ربط استعمال کریں جہاں آپ کتاب کے صفحات پڑھ سکیں۔"
		},
		"convertToPdf" : {
			"pdf" : "پی ڈی ایف",
			"images" : "صفحات"

...
const ur = {
    ...
    editor: {
        ...
        uploadImage: {
            uploadInstructions: "اپنی ڈیوائس سے فائل اپلوڈ کریں:",
            addViaUrlInstructions: "یا ربط سے عکس لیں:",
            autoCompletePlaceholder: "عکس کا ماخذ چسپاں کریں یا چنیں",
            alt: "متبادل:",
            title: "عنوان:",
        },
        imageEditor: {
            editImage: "عکس کی تدوین",
        },
        createLink: {
            url: "ربط",
            urlPlaceholder: "ربط چنیں یا چسپاں کریں",
            title: "عنوان",
            saveTooltip: "ربط مہیّا کریں",
            cancelTooltip: "تبدیلی رد کریں",
        },
        linkPreview: {
            open: "{{url}} نئی ونڈو میں کھولیں",
            edit: "ربط کی تدوین",
        ...
        table: {
            ...
            insertColumnLeft: "بائیں جانب کالم بنائیں",
            insertColumnRight: "دائیں جانب کام بنائیں",
            deleteColumn: "کالم ہٹائیں",
            rowMenu: "سطری مینو",
            insertRowAbove: "اوپر سطر بنائیں",
            insertRowBelow: "نیچے سطر بنائیں",
            deleteRow: "سطر ہٹائیں",
        },
        toolbar: {
            blockTypes: {
                paragraph: "پیراگراف",
            ...
            blockTypeSelect: {
                selectBlockTypeTooltip: "بلاک کی قسم چنیں",
                placeholder: "بلاک کی قسم",
            },
            toggleGroup: "گروپ ٹاگل کریں",
            removeBold: "جلی ہٹائیں",
            bold: "جلی",
            removeItalic: "ترچھا ہٹائیں",
            italic: "ترچھا",
            underline: "خط زد",
            removeUnderline: "خط زد ہٹائیں",
            removeInlineCode: "کوڈ فارمیٹ ہٹائیں",
            inlineCode: "بین السطور کوڈ فارمیٹ",
            link: "ربط بنائیں",
            richText: "خوبصورت متن",
            diffMode: "تقابل تبدیلی",
            source: "سورس",
            admonition: "اڈومینیشن داخل کریں",
            codeBlock: "کوڈ بلاک بنائیں",
            editFrontmatter: "فرنٹ میٹر کی تدوین",
            insertFrontmatter: "فرنٹ میڑت بنائی﷽",
            image: "تصویر بنائیں",
            insertSandpack: "سینڈ پیک داخل کریں",
            table: "جدول بنائیں",
            thematicBreak: "خط داخل کریں",
            bulletedList: "فہرست",
        ...
        admonitions: {
            ...
            info: "معلومات",
            caution: "تنبیح",
            changeType: "اڈومینیشن کی قسم چینں",
            placeholder: "اڈومینیشن کی قسم",
        },
        codeBlock: {
            language: "کوڈ بلاک کی زبان",
            selectLanguage: "کوڈ بلاک کی زبان چنیں",
        },
        contentArea: {
            editableMarkdown: "مارک ڈاؤن کی تدوین",
        },
    },
};
